...
### Notes
- `localhost` loopback compatibility remains implemented: when the server host is set to `localhost`, the listener still attempts to register both `localhost` and `127.0.0.1` with automatic fallback.
